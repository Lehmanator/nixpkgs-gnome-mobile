...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitLab {
    ...
    owner = "verdre";
    repo = "mobile-mutter";
    hash = "sha256-RxLJszk1smR/OwotK8pjSB1mgAVv+iWUFsSV1h3SuT8="; # Branch: mobile-shell-devel (2024-02-14)
    rev = "2c538763f7cdcd8dec29fbf602b930c60862f019"; # # Branch: mobile-shell-devel (2024-02-14)
  };
