...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitLab {
    ...
    repo = "mobile-mutter";
    hash =
      lib.fakeHash; # "sha256-D9TWF09XhqfBZyKXiPaQE+Fa+3mKG2CAdyi8nAsYa+c="; # Branch: mobile-shell-devel (02/12)
    rev = "0f08f5aba4c9b5ac34b2d5711182d50b719d838e"; # # Branch: mobile-shell-devel (02/12)
