...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitLab {
      ...
      rev = "259e12cfbe7060cdf63e106d275c0ee0d0158906"; # # Branch: mobile-shell-devel (11/23)
      hash =
        lib.fakeHash; # "sha256-b9TJlePcBi9njlly7Qx5UpfLj9pbTQUaB9rztNcnUMA="; # # Branch: mobile-shell-devel (11/23)
